...
def load_words(category):
    ...
    with urllib.request.urlopen('https://raw.githubusercontent.com/Marcovandervlag/Spaans_leren/main/spanish_words.txt') as f:
        content = f.read().decode('utf-8')
    
    # Split the string into lines and parse each line as a list of values
    words = [line.strip().split(',') for line in content.splitlines()]
